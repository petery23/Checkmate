...
const monitorNotificationEscalationValidation = z.object({
	delayMinutes: z.number().int().min(1),
	channelId: z.string().min(1),
});

const monitorNotificationConfigValidation = z.object({
	channelId: z.string().min(1),
	escalation: monitorNotificationEscalationValidation.optional(),
});
...
export const createMonitorBodyValidation = z.object({
	...
	notificationConfig: z.array(monitorNotificationConfigValidation).optional(),
